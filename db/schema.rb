...
ActiveRecord::Schema[8.1].define(version: 2026_08_18_160000) do
  ...
  create_table "artworks", force: :cascade do |t|
    ...
    t.string "crop_focus_x"
    t.string "crop_focus_y"
    t.string "current_location"
    t.boolean "favourite", default: false, null: false
    t.integer "height"
    t.string "license"
    t.decimal "max_crop_fraction", precision: 3, scale: 2
    t.string "medium"
    ...
    t.index ["favourite"], name: "index_artworks_on_favourite"
  ...
  create_table "displays", force: :cascade do |t|
    ...
    t.decimal "matte_inset", precision: 4, scale: 3, default: "0.0", null: false
